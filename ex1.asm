...
#-------------------------------------------------------------------------------
	...
	nowHeading: .word 0
#---------------------------------------------------------
# đường đi của masbot được lưu trữ vào mảng path
# mỗi 1 cạnh được lưu trữ dưới dạng 1 cấu trúc (struct trong C)
# 1 struct có dạng {x, y, z}
# trong đó: 	x, y là tọa độ điểm đầu tiên của cạnh
#		z là hướng của cạnh đó
# mặc định:	struct đầu tiên sẽ là {0,0,0}
# độ dài đường đi ngay khi bắt đầu là 12 bytes (3x 4byte) 
#---------------------------------------------------------
	path: .space 600
